...
import com.soulsync.security.WebSocketAuthInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        // Pure WebSocket endpoint — no SockJS, modern browsers handle WS natively
        // JWT in STOMP CONNECT headers is the real auth gate
